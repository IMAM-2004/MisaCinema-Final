    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        body {
            ...
            margin: 0;
            padding: 20px; /* Reduced padding for mobile default */
            min-height: 100vh;
        }
        ...
        .header h1 { 
            color: #e50914; margin: 0; font-size: 1.8rem;
        ...
        .movie-title { 
            font-size: 1.3rem; font-weight: bold; color: white; margin-bottom: 10px; 
            line-height: 1.2;
        }
        ...
        .seats-badge { 
            background: #333; color: #fff; padding: 4px 8px; border: 1px solid #444;
            border-radius: 4px; font-size: 0.8rem; margin-right: 4px; margin-bottom: 4px;
        ...
        .action-section {
            ...
            justify-content: center; align-items: center; min-width: 170px; border-left: 1px solid #333;
        }
        ...
        .btn-ticket {
            background: white; color: #000; padding: 10px 20px; 
        ...
        @media (max-width: 768px) {
            body { padding: 15px 10px; } /* Less padding on phone edges */
            
            .header h1 { font-size: 1.5rem; }
            
            .booking-card { flex-direction: column; }
            
            /* Make Poster a Banner */
            .poster-img { 
                width: 100%; 
                height: 180px; /* Short banner height */
                background-position: center 20%; /* Focus on the top part of poster so faces aren't cut */
            }
            ...
            .status { margin-bottom: 0; display: none; } /* Hide 'Paid' text on mobile to save space, keeping price */
...
<div class="container">
    ...
    foreach ($myBookings as $booking): 
        ...
        // 2. DATA GAMBAR
        $posterUrl = 'assets/img/default_poster.jpg'; 
